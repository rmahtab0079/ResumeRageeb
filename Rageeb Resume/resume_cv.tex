...
\email{rageeb1997@gmail.com}
\homepage{www.rageebmahtab.com}
\github{rmahtab0079}
\linkedin{rageebmahtab}
%\skype{skypeid}
...
\makecvfooter{\today}{Rageeb Mahtab~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
